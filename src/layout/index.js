        ...
        return (
                <Layout
                        ...
                        style={{
                                minHeight: '100vh',
                                display: 'none',
                                '--localeFont': ['cn', 'hk'].includes(getLocale()) ? '1.4rem' : '1rem'
                        }}>
                        <SideBar/>
                        <Layout>
                                ...
                                <Header style={{padding: '0 1rem', height: '4.8rem', borderTop: `0.1rem solid ${colorBorderSecondary}`, background: colorBgContainer}}>
                                        <TabHistory/>
                                </Header>
                                <Content
                                ...
                                >
                                        <AuthRoute>
                                                <Suspense fallback={<Spin size="large" className="content_spin"/>}>
                                                        <Card id="contentLayout" wrap gutter={[0, 50]} layout="center" style={{minHeight: '100%'}}>
                                                                <Outlet/>
                                                        </Card>
                                                </Suspense>
                                        </AuthRoute>
